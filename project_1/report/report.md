...
$$
  \hat{\boldsymbol{\beta}} = \max_{\boldsymbol{\beta}} L(\boldsymbol{\beta}, \sigma^2) \iff \hat{\boldsymbol{\beta}} = \max_{\boldsymbol{\beta}} ln[L(\boldsymbol{\beta}, \sigma^2)],
$$
...
| Metric | Polynomial degree | OLS | Ridge ($\lambda=100$) | LASSO ($\lambda$) |
| :---: | :---: | :---: | :---: | :---: |
...
This section present the results of polynomial regression conducted on samplings from digital elevation data (see [](#figure-14)). 
...
The Julia source code used to generate the test results is available at [](https://github.com/semapheur/fys-stk4155).
